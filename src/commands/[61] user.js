...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    embed.setDescription(`${emojis.yildiz} **Kullanıcı Bilgisi:**
    ...
    ${emojis.ping2} \`Mikrofonu:\` ${Member.voice.mute ? `Kapalı ${red}` : `Açık ${green}`}
    ${emojis.ping2} \`Kulaklığı:\` ${Member.voice.deaf ? `Kapalı ${red}` : `Açık ${green}`}
