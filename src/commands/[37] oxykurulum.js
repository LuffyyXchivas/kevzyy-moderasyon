...
module.exports = {
  ...
  run: async (client, message, args, embed, prefix) => {
    ...
    if (args[0] === "info" || args[0] === "help") {
      ...
      .setDescription(`
      \`•\` **Emoji kurulumu** yapılmadıysa \`${prefix}panel emoji\` 
      \`•\` **Katılımcı kurulumu** yapılmadıysa \`${prefix}panel katılımcı\` 
      \`•\` **Burç kurulumu** yapılmadıysa \`${prefix}panel burç\`
      \`•\` **Oyun kurulumu** yapılmadıysa \`${prefix}panel game\`
      \`•\` **İlişki kurulumu** yapılmadıysa \`${prefix}panel ilişki\`
      \`•\` **Panel kurulumu** yapılmadıysa \`${prefix}panel panel\`
      \`•\` **Sunucu kurulumu** yapılmadıdıysa \`${prefix}panel guildCreate\`
      \`•\` **Rol kurulumu** yapılmadıdıysa \`${prefix}panel rolKurulum\`
      \`•\` **Log kurulumu** yapılmadıysa \`${prefix}panel logKurulum\`
      \`•\` **Register** Komutları için  \`${prefix}panel register help\` 
      \`•\` **Cezalandırma** Komutları için \`${prefix}panel penals help\``));
    }
      ...
      if (args[1] === "help" || args[1] === "yardım") {
        ...
        let inviteChannel = conf.invite.channel || [];
            ...
            .setColor(conf.colors.renk_mor).setDescription(`
              **Rol ayarları :**
               \`•\` ${prefix}panel register manRoles **[@ID]**
               \`•\` ${prefix}panel register womanRoles **[@ID]**
               \`•\` ${prefix}panel register unregister **[@ID]**
               \`•\` ${prefix}panel register staff **[@ID]**
               \`•\` ${prefix}panel register special **[@ID]**
               \`•\` ${prefix}panel register ressam **[@ID]**
               \`•\` ${prefix}panel register streamer **[@ID]**
               \`•\` ${prefix}panel register envoy **[@ID]**
               \`•\` ${prefix}panel register sponsor **[@ID]**
               \`•\` ${prefix}panel register vocal **[@ID]**
               
               **Kanal Ayarları :**
               \`•\` ${prefix}panel register channel **[@ID]**
               \`•\` ${prefix}panel register voiceChannel **[@ID]**
               \`•\` ${prefix}panel register invChannel **[@ID]**`)
      ...
      if (args[1] === "help" || args[1] === "yardım") {
        ...
        .setColor(conf.colors.renk_mor).setDescription(`
          **Yetkili rol ayarları :**
           \`•\` ${prefix}panel penals banStaffs **[@ID]**
           \`•\` ${prefix}panel penals jailStaffs **[@ID]**
           \`•\` ${prefix}panel penals cMutedStaffs **[@ID]**
           \`•\` ${prefix}panel penals vMutedStaffs **[@ID]**
           \`•\` ${prefix}panel penals adsStaffs **[@ID]**

           **Rol ayarları :**
           \`•\` ${prefix}panel penals jailRoles **[@ID]**
           \`•\` ${prefix}panel penals cMutedRoles **[@ID]**
           \`•\` ${prefix}panel penals vMutedRoles **[@ID]**
           \`•\` ${prefix}panel penals adsRoles **[@ID]**
           
           **Kanal Ayarları :**
           \`•\` ${prefix}panel penals banChannel **[@ID]**
           \`•\` ${prefix}panel penals jailChannel **[@ID]**
           \`•\` ${prefix}panel penals cMuteChannel **[@ID]**
           \`•\` ${prefix}panel penals vMuteChannel **[@ID]**
           \`•\` ${prefix}panel penals adsChannel **[@ID]**

           **Limit Ayarları :**
           \`•\` ${prefix}panel penals banLimit **[0-100]**
           \`•\` ${prefix}panel penals jailLimit **[0-100]**
           \`•\` ${prefix}panel penals cMuteLimit **[0-100]**
           \`•\` ${prefix}panel penals vMuteLimit **[0-100]**
           \`•\` ${prefix}panel penals adsLimit **[0-100]**
   `),{ buttons: [info] })
      }
...
const serverEmojis = [
  ...
  { name: "tacc", url: "https://cdn.discordapp.com/attachments/827439712834158622/827439808544243762/tacc.gif" },
    { name: "info", url: "https://cdn.discordapp.com/emojis/1013100560007831572.png"},
  { name: "zaman", url: "https://cdn.discordapp.com/emojis/1013100802249850890.png"},
  { name: "yildiz", url: "https://cdn.discordapp.com/emojis/1012681624942555147.gif"},
  { name: "ping", url: "https://cdn.discordapp.com/emojis/1011327669180321842.png"},
  { name: "ping2", url: "https://cdn.discordapp.com/emojis/1012666509946007634.png"},
  ...
  { name: "kevzyyuser", url: "https://cdn.discordapp.com/attachments/910788803747270657/954648813279252500/932282826030743582.png" },
  { name: "kevzyytaggeds", url: "https://cdn.discordapp.com/attachments/910788803747270657/954648812813688862/926420103539593246.png" },
  { name: "kevzyybooster", url: "https://cdn.discordapp.com/attachments/910788803747270657/954648812998242314/932282825657446421.png" },
  { name: "kevzyyvoice", url: "https://cdn.discordapp.com/attachments/910788803747270657/954648813539319859/932282826206904340.png" },
  { name: "kevzyylink", url: "https://cdn.discordapp.com/attachments/910788803747270657/910945113507762288/901887875891752981.png" },
  { name: "kevzyytrash", url: "https://cdn.discordapp.com/attachments/910788803747270657/910945327366955068/897188574347296828.png" },
  { name: "kevzyygift", url: "https://cdn.discordapp.com/attachments/910788803747270657/910945113088348170/901887438115467304.png" },
  { name: "kevzyypc", url: "https://cdn.discordapp.com/attachments/910788803747270657/910945327761199124/893023470961692722.png" },
];
const numEmojis = [
...
const roles = [
  ...
  { name: "💖 Lovers", color: "#ff0000" },
  { name: "💔 Alone", color: "#050505" },
  { name: "🖤 Sevgili yapmıyorum", color: "#fcfffd" },
  { name: "▬▬▬▬▬▬▬▬▬▬", color: "#f8f8f8" },
];
let modChannels = [
